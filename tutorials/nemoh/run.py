...
nemoh_data = NemohOutput(sim_dir='./data/two_body', cal_file='Nemoh.cal', results_dir='Results', mesh_dir='Mesh', out_name='./data/two_body.out')
...
for i in xrange(nemoh_data.data[0].num_bodies):
	nemoh_data.data[i].nondimensionalize_hydro_coeffs()
